...
#     drift = truncnorm_better(0, 3, low=0.0, high=np.inf, size=batch_size)
#     a0 = truncnorm_better(2, 2.5, low=0.25, high=np.inf, size=batch_size)
#     lamda = truncnorm_better(1, 2, low=0.0, high=np.inf, size=batch_size)
...
#     lamda = truncnorm_better(1, 2, low=0.0, high=np.inf, size=batch_size)
#     tau = truncnorm_better(0, 0.75, low=0.0, high=np.inf, size=batch_size)
#     sigma_z = truncnorm_better(0, 0.25, low=0.001, high=np.inf, size=batch_size)
